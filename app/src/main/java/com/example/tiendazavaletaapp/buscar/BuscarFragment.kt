...
import com.example.tiendazavaletaapp.home.ListCategoriaAdapter
import com.example.tiendazavaletaapp.home.ProductosHomeAdapter
import com.google.firebase.firestore.FirebaseFirestore

class BuscarFragment: Fragment() {
    private  val db= FirebaseFirestore.getInstance()
    private val colleccion= db.collection("producto")
    private lateinit var adapterB: ListCategoriaAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterB = ListCategoriaAdapter(emptyList())
